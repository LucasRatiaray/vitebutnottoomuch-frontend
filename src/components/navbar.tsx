...
export function Navbar() {
  ...
  return (
    <>
      <header
        className={cn(
          'border-secondary dark:bg-navbar bg-primary/10 bg-opacity-15 sticky top-5 z-40 mx-auto flex w-[90%] items-center justify-between rounded-2xl border px-2 py-2.5 shadow-inner backdrop-blur-sm transition-transform duration-300 ease-in-out md:w-[70%] lg:w-[75%] lg:max-w-screen-xl',
